...
def retrieve_from_taxid(taxon_list: List[Taxon], user_email: str, retries: int) -> None:
...
def retrieve_from_names(taxon_list: List[Taxon], user_email: str, correction: bool, retries: int) -> None:
...
def retrieve_taxonomy(taxon_list: List[Taxon], user_email: str, retries: int) -> None:
